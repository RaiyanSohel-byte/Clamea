...
const Footer = () => {
  const socialLinks = [
    {
      name: "LinkedIn",
      href: "https://linkedin.com/company/clamea", // Uppdatera med er faktiska länk
      icon: (
    ...
    {
      name: "Instagram",
      href: "https://instagram.com/clamea", // Uppdatera med er faktiska länk
      icon: (
  ...
  // Definition of menus as per your requirements
  const footerMenus = [
    {
      title: "Product",
      links: ["Funktioner", "Säkerhet", "Väntelista"],
    },
    {
      title: "Company",
      links: ["Om oss", "Kontakt"],
    },
    {
      title: "Legal",
      links: ["Villkor", "Integritet", "Cookies"],
    },
  ];
      ...
      <div className="container mx-auto max-w-7xl px-6 lg:px-12 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-20">
          ...
          <div className="col-span-2 lg:col-span-2 space-y-8">
            <div className="flex flex-col gap-5">
              ...
              <p className="text-slate-400 max-w-sm leading-relaxed text-base font-normal">
                Clamea hjälper dig att förstå, hantera och följa ditt
                försäkringsärende – från start till beslut.
                <br />
                <br />
                Vi samlar information, struktur och vägledning i en och samma
                app.
              </p>
            </div>
            ...
            <div className="flex gap-4">
              {socialLinks.map((social, i) => (
                <a
                  ...
                  className="w-11 h-11 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center transition-all duration-300 hover:bg-[#1AA9F4] hover:border-[#1AA9F4] hover:-translate-y-1 text-slate-300 hover:text-white"
                >
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-[10px] font-bold text-slate-500 tracking-widest uppercase">
            © {new Date().getFullYear()} Clamea AB. Alla rättigheter
            förbehållna.
          </p>
